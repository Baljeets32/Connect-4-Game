...
public class Board 
{
    // This class is created to provide the Board manipulation functionality 
	...
	while(true)
        {
            try
            {
            		Thread.sleep(1000);
            	lock.lock();   
                while(checked == 1)   // checked 0 - refree checked
                {
                ...
                make_the_move(color);
                checked = 1;		// board changed  - refree needs to check, turn taken by player (moved)
